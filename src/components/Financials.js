...
import IncomeQ from "./IncomeQ";
import BalanceA from "./BalanceA";
import BalanceQ from "./BalanceQ";
import CashflowA from "./CashflowA";
import CashflowQ from "./CashflowQ";
...
const Financials = () => {
    ...
    return <Fragment>
            ...
            {report === "income-statement" && period === "annual" && <IncomeA/>}
            {report === "income-statement" && period === "quarter" && <IncomeQ/>}
            {report === "balance-sheet" && period === "annual" && <BalanceA/>}
            {report === "balance-sheet" && period === "quarter" && <BalanceQ/>}
            {report === "cash-flow" && period === "annual" && <CashflowA/>}
            {report === "cash-flow" && period === "quarter" && <CashflowQ/>}
